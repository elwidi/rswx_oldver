...
include "../konek.php";
include "../ceke.php";
$kdjfkdjkfjdkfdk = mysql_query("SELECT * FROM kot WHERE id='$id'");
...
<input type="text"  name="NamaKec"class="style22" size="20" maxlength="100" value="<? echo $hap[NamaKot]; ?>"><?
if($id>0){
?>
...
if($id>0){
?>
<input type="button" name="ddfdfdfd" value="Reset" onClick="location.href='c3ws3.php';">
<?
}
?>
...
<td width="198" bgcolor="#990033"><span class="style2">Nama KOTA</span></td>
...
$nomer=1;
if($id>0){
$kdjfkdjkfdkfdjkfd = mysql_query("SELECT * FROM kot WHERE id='$id'");
}else{
$kdjfkdjkfdkfdjkfd = mysql_query("SELECT * FROM kot ORDER BY NamaKot");
}
...
<td><div align="left"><? echo ucfirst(strtolower($nn[NamaKot])); ?></div></td>
...
<td    onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" 
 onClick="location.href='c3ws3.php?id=<? echo $nn[id]; ?>';"><div align="center">
Edit
</div></td>
</tr>
<?
