		...
		$('#suggest3').autocomplete('ss3.php', 
			{
				...
				parse: function(data){ 
					...
					for (var i=0; i < data.length; i++) {
						parsed[i] = {
							data: data[i],
							value: data[i].Diagnosa // nama field yang dicari
...
str += '<u>'+data.Diagnosa+'</u><br />DTD.'+data.NoDtd+'</u><br />NO DATA.'+data.NoData;;					
					str += '';
					return str;
				},
...
var Result =''+data.id+'';;
location.href="d_jhs.php?id=<? echo $id; ?>&IdDetil=" + Result;
			}
		);
	});
  </script> </head>
