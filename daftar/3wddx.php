...
include "../konek.php";
include "../ceke.php";
$kdidkdikd = mysql_query("SELECT * FROM keluarmasukpasien WHERE id='$id'");
...
VALUES (NULL, 'RI:$id', '$uh[NoPasien]', '$uh[NamaPasien]', 'Rwt Inap', '$Ket', '$a[User]', '$TglJam', '$uh[TglMasuk]', '$uh[BlnMasuk]', '$uh[ThnMasuk]')");
//
...
`Tgl` = '$uh[TglMasuk]',
`Bln` = '$uh[BlnMasuk]',
`Thn` = '$uh[ThnMasuk]' WHERE `ket_pas_pul`.`IdPasien` ='RI:$id'");
}
header("Location:txn/f_f.php?doa=baik&id=$id");
