...
include "../konek.php";
include "../ceke.php";
$kdjfkdjkfjdkfdk = mysql_query("SELECT * FROM kecamatan WHERE id='$id'");
...
<input type="text"  name="NamaKec"class="style22" size="20" maxlength="100" value="<? echo $hap[NamaKec]; ?>"><?
if($id>0){
?>
...
if($id>0){
?>
<input type="button" name="ddfdfdfd" value="Reset" onClick="location.href='c3ws2.php';">
<?
}
?>
...
<td width="198" bgcolor="#990033"><span class="style2">Nama Kecamatan</span></td>
...
$nomer=1;
if($id>0){
$kdjfkdjkfdkfdjkfd = mysql_query("SELECT * FROM kecamatan WHERE id='$id'");
}else{
$kdjfkdjkfdkfdjkfd = mysql_query("SELECT * FROM kecamatan ORDER BY NamaKec");
}
...
<td><div align="left"><? echo ucfirst(strtolower($nn[NamaKec])); ?></div></td>
...
<td    onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" 
 onClick="location.href='c3ws2.php?id=<? echo $nn[id]; ?>';"><div align="center">
Edit
</div></td>
</tr>
<?
