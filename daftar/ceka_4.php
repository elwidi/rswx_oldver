...
<head><script type='text/javascript' src='js/jquery-1.3.2.min.js'></script>
  ...
  <script language="javascript">
    $(function(){
		...
		$('#suggest4').autocomplete('loka_s4.php', 
			{
				...
				parse: function(data){ 
					...
					for (var i=0; i < data.length; i++) {
						parsed[i] = {
							data: data[i],
							value: data[i].Kecamatan  // nama field yang dicari
...
str += '<u>'+data.Kecamatan+'</u><br /Kota.'+data.Kota+'<br />Kelurahan: '+data.Kelurahan+'<br />Propinsi: '+data.Propinsi;;					
					str += '';
					return str;
				},
...
var Result =''+data.Kecamatan+'';;
location.href="puasa_9_bulan.php?hari=supran&Kecamatan=" + Result;
			}
		);
	});
  </script></head>
