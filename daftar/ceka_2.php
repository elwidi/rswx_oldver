...
<head><script type='text/javascript' src='js/jquery-1.3.2.min.js'></script>
  ...
  <script language="javascript">
    $(function(){
		...
		$('#suggest2').autocomplete('loka_s2.php', 
			{
				...
				parse: function(data){ 
					...
					for (var i=0; i < data.length; i++) {
						parsed[i] = {
							data: data[i],
							value: data[i].NamaKel  // nama field yang dicari
...
var Result =''+data.NamaKel+'';;
location.href="puasa_9_bulan.php?hari=ayah&Kelurahan=" + Result;
			}
		);
	});
  </script></head>
