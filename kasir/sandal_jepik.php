...
<div align="left">
 ...
 <?
 $nomer=1;
 $kfgfkgjfkjgkf = mysql_query("SELECT * FROM  tabelri WHERE NamaBiaya LIKE '$NamaBiaya%' ");//AND KodeKelompok !=2 AND KodeKelompok !=3 limit 0,100");
 ...
 ?>
 <tr  <? echo $warna; ?> valign="top"  onClick="location.href='jalan_panjang0.php?JasaDokter=<? echo $vv[JasaDokter]; ?>&IdBiaya=<? echo $vv[id]; ?>&IdPasien=<? echo $IdPasien; 
?>&IdStruk=<? echo $IdStruk; ?>';" onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';">
