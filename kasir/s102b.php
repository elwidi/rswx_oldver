...
<td width="67" rowspan="2" bgcolor="#CCFFCC"><strong>JENIS KB </strong></td>
<td colspan="2" bgcolor="#CCFFCC"> <div align="center"><strong>TANGGAL</strong></div></td>
...
<tr>
<td width="78" bgcolor="#CCFFCC"><strong>PERIKSA</strong></td><td width="105" bgcolor="#CCFFCC"><div align="right"><strong>PERIKSA BERIKUT</strong></div></td> 
</tr>
<?
$nomer=1;
$kdjfkdjkfd = mysql_query("SELECT * FROM kb WHERE TglMasuk>=$tgl1 AND TglMasuk<=$tgl2 AND BlnMasuk=$bln AND ThnMasuk=$thn1");
...
<tr valign="top"  <? echo $warna; ?>>
  ...
  <td><div align="left"><? echo $aa[JenisKb]; ?></div></td>
  <td><div align="right"><?
  echo "$aa[TglMasuk]-$aa[BlnMasuk]-$aa[ThnMasuk]";
  ?></div></td>
  <td><div align="right"><?
  echo "$aa[TglKembali]-$aa[BlnKembali]-$aa[ThnKembali]";
  ?></div></td>     
