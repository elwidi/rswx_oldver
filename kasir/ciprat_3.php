...
<head><script type='text/javascript' src='js/jquery-1.3.2.min.js'></script>
  ...
  <script language="javascript">
    $(function(){
		...
		$('#suggest3').autocomplete('cari3.php', 
			{
				...
				parse: function(data){ 
					...
					for (var i=0; i < data.length; i++) {
						parsed[i] = {
							data: data[i],
							value: data[i].Telp // nama field yang dicari
...
str += '<u>'+data.Telp+'</u><br />No RM.'+data.NoPasien+'<br />NAMA PASIEN: '+data.NamaPasien+'<br> Alamat'+' :'+data.Alamat+'<br>TGL LAHIR : '+data.tgllhr;;					
					str += '';
					return str;
				},
