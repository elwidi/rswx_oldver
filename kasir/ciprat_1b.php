...
str += '<u>'+data.NamaPasien+'</u><br />No RM.'+data.NoPasien+'<br />ALAMAT: '+data.Alamat+'<br> '+data.Telp+' :'+data.Telp+'<br>TGL LAHIR : '+data.tgllhr;;					
					str += '';
					return str;
				},
...
var Result =''+data.id+'';;
location.href="fitri_istri_supran.php?mas=hari&id=" + Result;
			}
		);
	});
  </script></head>
