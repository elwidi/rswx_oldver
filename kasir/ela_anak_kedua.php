...
<?
echo ucfirst(strtolower($ph[NamaPasien])); ?><font color="#990000">( <? echo $ph[NoPasien]; ?> )</font><? 
?><br> Jenis Kb : <? echo ucfirst(strtolower($ph[JenisKb])); ?><br>
<span class="style3">
<a href="sriharsana_ibu_ayahku.php?id=<? echo $id; ?>" style="background-color:#CCFF00"  >YA</a> || 
