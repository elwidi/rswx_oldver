...
<head><script type='text/javascript' src='js/jquery-1.3.2.min.js'></script>
  ...
  <script language="javascript">
    $(function(){
		...
		$('#suggest4').autocomplete('../Daftar/cari_aja3.php', 
			{
...
var Result =''+data.id+'';;
location.href="sabar_ya.php?budi=<? echo $budi; ?>&IdDokter=<? echo $IdDokter; ?>&IdRujukan=<? echo $IdRujukan; ?>&id=<? echo $id; ?>&IdDept=<? echo $IdDept; ?>&IdPenjamin=" + Result;
			}
		);
	});
  </script></head>
