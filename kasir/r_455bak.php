...
<tr onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" onClick="location.href='re4.php?id=<? echo $id; ?>';" >
...
$kdfkfd_Dfdfddf = mysql_query("SELECT COUNT(id) AS hh FROM jualobat WHERE apa_r=1 AND RegId='$hh[RegId]'");
$yss = mysql_fetch_array($kdfkfd_Dfdfddf);
if($yss[hh]>0){
$Obate = $uj[hh]+$gu[Racikan];
}else{
$Obate = $uj[hh];
}
echo number_format($Obate);?>
 </div></td> 
  </tr>
  <?
  }
  ...
  <td colspan="2" bgcolor="#FFFFFF"><div align="center"><strong>TOTAL</strong></div></td><td bgcolor="#FFFFFF"><div align="right"><strong>
	...
	$kabeh3=$kabeh2x+$kabeh2+$kabeh+$Obate;
