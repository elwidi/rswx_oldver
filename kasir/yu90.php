...
//
$ksjdskds_dsds = mysql_query("SELECT * FROM vaksin_pasien2 WHERE IdPasen='$id'");
$ii= mysql_fetch_array($ksjdskds_dsds);
///////////////////////////////////==========================
$idfdfd_DFdfdfdf =  mysql_query("SELECT * FROM bacth_vaksin2 WHERE IdRj='$id'");
...
<?
if($ii[id]){
?><form action="tagihane_lama_bgt2.php">
<? }else{ ?>
<form action="aku_tetap_konsisten2.php">
