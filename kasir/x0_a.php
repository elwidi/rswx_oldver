...
include "../rake.php";
include "../alamat.php";
$ssljil_00l = mysql_query("SELECT * FROM returobatjalan WHERE id='$id'");
$b= mysql_fetch_array($ssljil_00l);
if(!$b[id]){
...
FAX : <? echo $fkd[Fax]; ?> </span></td>
	...
	<table width="100%" cellspacing="1" cellpadding="5">
	  <tr>
		...
		<td width="79%" valign="top">RTR.<? echo $b[id];?></td>
	  </tr>
	  <tr>
		<td valign="top"><strong>Sudah Terima dari</strong></td>
		<td valign="top"><strong>:</strong></td>
		<td valign="top">Rs YADIKA </td>
	  </tr>
	  ...
	  <tr>
	    ...
	    <td valign="top">:</td>
	    <td valign="top"><? echo ucfirst(strtolower($b[NamaPasien])); echo "($b[NoPasien])"; ?></td>
      </tr>
	  <tr>
		<td valign="top"><strong>Untuk Pembayaran </strong></td>
		<td valign="top"><strong>:</strong></td>

		<td valign="top">Pengembalian Dana Atas Transaksi Retur <br />
		Penjualan Obat Farmasi Resep No : <? echo $b[NoResep]; ?> </td>
	  </tr>
	  <tr>
		<td valign="top">&nbsp;</td>
		<td valign="top">&nbsp;</td>
		...
		&nbsp;&nbsp;&nbsp;Rp<? echo number_format($b[Total]); ?>&nbsp;&nbsp;&nbsp;		</span>		</td>
		...
		<table width="100%">
			<tr  valign="bottom">
			  <td width="50%" align="center">
					&nbsp;
				    (<? echo strtoupper($b[NamaPasien]); ?>)<br />
		      <br /></td>
				<td width="50%" align="right">
					Bekasi, <? echo "$b[Tgl]/$b[Bln]/$b[Thn]"; ?><br><?
					  ?>					<br /><br /><br /><br/><br/>
