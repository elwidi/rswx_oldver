...
FAX : <? echo $fkd[Fax]; ?> </span></td>
	...
	<table width="100%" cellspacing="1" cellpadding="5">
	  <tr>
		...
		<td width="79%" valign="top">Man:<? echo $b[id];?></td>
	  </tr>
	  <tr>
	  ...
	  <tr>
		...
		<td valign="top">
		<?
		$nila = $b[Tunai]+$b[Db]+$b[Kk];
		include "../terbilang.php";
		$kalimat = terbilang($nila);
    ...
    <td valign="top"><strong>Pasien</strong></td>
	    <td valign="top">:</td>
	    <td valign="top"><? echo $b[NamaPasien]; ?></td>
      </tr>
	  <tr>
		<td valign="top"><strong>Untuk Pembayaran </strong></td>
		<td valign="top"><strong>:</strong></td>

		<td valign="top"><? echo ucfirst(strtolower($b[Keterangan])); ?></td>
	  </tr>
	  <tr>
		<td valign="top">&nbsp;</td>
		<td valign="top">&nbsp;</td>
		...
		&nbsp;&nbsp;&nbsp;Rp<? echo number_format($nila); ?>&nbsp;&nbsp;&nbsp;		</span>		</td>
			...
			<tr  valign="bottom">
		      ...
		      <br /></td>
				<td width="50%" align="right">
					Bekasi, <? echo "$b[TglBayar]/$b[BlnBayar]/$b[ThnBayar]"; ?><br><?
					echo " ( $b[JamBayar] )"; ?>					<br /><br /><br /><br/><br/>
