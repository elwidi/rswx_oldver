...
var Result =''+data.id+'';;
location.href="sabar_ya.php?NamaPenjamin=%&budi=<? echo $budi; ?>&IdDokter=<? echo $IdDokter; 

 ?>&id=<? echo $id; 

 ?>&IdDept=<? echo $IdDept; ?>&IdDokter=<? echo $IdDokter; ?>&IdRujukan=" + Result;
			}
		);
	});
  </script></head>
