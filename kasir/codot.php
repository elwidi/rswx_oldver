...
<div align="left">
  <table onClick="location.href='sabar_itu_baik.php?id=<? echo $id; ?>';" onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" border="0" cellpadding="0" cellspacing="0">
    <tr>
    <td width="358" colspan="3"><div align="center" class="style19">
    KARTU MASUK RAWAT INAP <br />
    RS YADIKA<br>
    </div></td>
    </tr>
    <tr>
