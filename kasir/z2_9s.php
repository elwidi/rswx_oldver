...
<tr valign="top">
 ...
 <? 
	 ...
	 <tr   valign="top">
	                                <td>Tunai</td>
                                    <td>:</td><td><div align="right"><? echo number_format($nil); ?></div></td>
	 </tr>
...
echo number_format($hg2c[NonJam]);
$tot_2c = $tot_2c + $hg2c[NonJam];
  ?> </div></td>
                  </tr>
                  <?
  $nomer++; }  
...
echo number_format($hg2[NonJam]);
$Tun2 = $Tun2 + $hg2[NonJam];
  ?>
                      </div></td>
                  </tr>
                  <?
...
echo number_format($hg3[NonJam]);
  ...
  ?>
                  <tr> 
                    ...
                    <td><div align="right"><strong><? $nile = $hg3[NonJam]+$Tun2+$Tun+$tot_2c;
