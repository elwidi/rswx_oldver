<?php
	 ...
	 * */
	if(isset($_GET['q'])){
		//mysql_connect('localhost','root','fitoeladimas'); # koneksi ke database
		//mysql_select_db('sirlam3'); # pilih table
		include "../konek.php";
		/* 
		...
		$query = mysql_query("SELECT * FROM dataobat WHERE NamaObat LIKE '%$param%' limit 0,50") or die(mysql_error());		
