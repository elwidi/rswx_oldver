...
//
$KDJKJKDFJ= mysql_query("SELECT * FROM jualobat WHERE id='$IdDetil'");
...
$Total=$HargaK*$Qty;
 ...
 $upda = mysql_query("UPDATE  `jualobat` SET `Qty` = '$Qty',`HargaBeli` = '$HargaK',
 `JmlHargaBeli` = '$Total',
`Operator` = '$a[Nama]' WHERE `jualobat`.`id` =$IdDetil"); 
...
<!-- 
function win44(){
window.opener.location.href="s_scc30k.php?id=<? echo $id; ?>&IdDetil=<? echo $IdDetil; ?>&Rc=<? echo $Rc; ?>&NoResep=<?  echo $NoResep; ?>";
self.close();
//-->
} 
</SCRIPT></head>
