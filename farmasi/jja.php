...
<td width="186"><div align="left" class="style3"><? echo strtoupper($NamaPasien); ?></div></td>
</tr>
<tr>
<td width="149"><span class="style3">STATUS</span></td><td width="17"><span class="style3">:</span></td>
<td width="186"><div align="left" class="style3">0</div></td>
</tr>
<tr>
...
<?
$juy = 1;
$ddt = mysql_query("SELECT * FROM jual_ob_rl_tmp WHERE   RegId='$RegId'");
...
<td><div align="right" class="style8"><? if($ss[TypeJual]==1){}else{
