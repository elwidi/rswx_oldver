...
<body>
 ...
 <tr>
   ...
   <input type="button" name="ffgf" value="Hapus" onClick="location.href='fgfgfgfgf.php?Rc=<? echo $Rc; ?>&NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>&IdDetil=<? echo $IdDetil; ?>';" class="style12">
