...
//
//
  $kdjfkdjkdkf_Dfdlfld3 = mysql_query("SELECT * FROM utility WHERE id=3");
$aas3 = mysql_fetch_array($kdjfkdjkdkf_Dfdlfld3);  
///
$padaa = strlen($c[NamaObat])-2;
$teks = substr($c[NamaObat],$padaa,2);
if($teks==".."){
...
?>
    <tr  <? echo $warna; ?> 
onClick="location.href='waheit.php?repot=bgt&IdGudang=<? echo $IdGudang; ?>&NoResep=<? echo $NoResep; ?>&Rc=<? echo $Rc; ?>&arum=<? echo $jumlah_beli1; ?>&aku=<? echo $aku; ?>&id=<? echo $id; ?>&IdObat=<? echo $c[id]; ?>';" onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" 
class="style11"><?  }elseif(!$bx[id]){
?><tr  <? echo $warna; ?>  class="style11"><? 
   }else{ ?>
    <tr   <? echo $warna; ?> 
onClick="location.href='waheit.php?repot=bgt&IdGudang=<? echo $IdGudang; ?>&NoResep=<? echo $NoResep; ?>&Rc=<? echo $Rc; ?>&arum=<? echo $jumlah_beli1; ?>&aku=<? echo $aku; ?>&id=<? echo $id; ?>&IdObat=<? echo $c[id]; ?>';" onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" 
class="style11">
