...
<table border="0" cellpadding="2" cellspacing="2" class="style23">
  <tr>
	<td width="30" bgcolor="#FFCCCC"><div align="center"><strong>NO</strong></div></td>
		<td width="328" bgcolor="#FFCCCC"><strong>NAMA OBAT</strong></td>
		<td width="51" bgcolor="#FFCCCC"><div align="center"><strong>QTY</strong></div></td>
		<td width="94" bgcolor="#FFCCCC"><div align="right"><strong>HARGA</strong></div></td>
		<td width="65" bgcolor="#FFCCCC"><div align="right"><strong>TOTAL</strong></div></td>
  </tr>
		<?
	 
 		$nomer=1;
 		$sdsjksjkds  = mysql_query("SELECT * FROM jualobat_tmp2 WHERE JamTran='$NoResep' AND apa_r=1  AND stat=$urr order by id  asc");
...
$warna='bgcolor="#C6FDBD"';
		...
		?>
 		<tr  <? echo $color;  echo $warna; ?> onClick="wComparew3www = window.open('hsa_z3x.php?NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>&IdDetil=<? echo $xx[id]; ?>', 
...
<tr>
 <tr>
    <td colspan="4" bgcolor="#9FBEDD"><div align="center">TOTAL</div></td>
		  <td bgcolor="#9FBEDD"><div align="right"><? echo number_format($tot); ?></div></td>
  </tr>
</table>
</body>
</html>