 ...
 <script type='text/javascript' src='js/jquery-1.3.2.min.js'></script>
  ...
  <script language="javascript">
    $(function(){
		...
		$('#suggest3').autocomplete('ss_2330.php', 
			{
				...
				parse: function(data){ 
					...
					for (var i=0; i < data.length; i++) {
						parsed[i] = {
							data: data[i],
							value: data[i].NoSo // nama field yang dicari
...
str += '<u>'+data.NoSo+'</u><br />Faktur '+data.NoFaktur+'<br />TGL: '+data.TglDtgl+' / '+data.BlnDtg+' / '+data.ThnDtg;;					
					str += '';
					return str;
				},
