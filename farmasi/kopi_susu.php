...
<form action="gula_pasir3.php"> 
  <div align="left">
           <table width="781" border="0" cellpadding="2" cellspacing="2" bordercolor="#000000" bgcolor="#FFFFFF">
			...
			//  echo "User Akses : $a[User] Level:$a[Level]";
			  ?></div></td>
    </tr>
          <?
		  if($a[Level]==11){}else{
    ...
    <td><div align="left" class="style11">:</div></td>
    <td><div align="left" class="style2">
      <textarea name="Alamat" cols="40" rows="3" class="style2"><? echo $xs[Alamat]; ?></textarea>
	   
      </div></td><td><div align="left" class="style12"></div></td>
    </tr>
	<?
	if($a[Level]==6){
	?>
