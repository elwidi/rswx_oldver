...
?>
    <tr  <? echo $warna; ?> 
onClick="location.href='waheit.php?IdGudang=<? echo $IdGudang; ?>&NoResep=<? echo $NoResep; ?>&Rc=<? echo $Rc; ?>&arum=<? echo $jumlah_beli1; ?>&aku=<? echo $aku; ?>&id=<? echo $id; ?>&IdObat=<? echo $c[id]; ?>';" onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" 
