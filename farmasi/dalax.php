...
$warna='bgcolor="#C6FDBD"';
		...
		?>
 		<tr  <? echo $color;  echo $warna; ?> onClick="wComparew3www = window.open('hsa_3x.php?NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>&IdDetil=<? echo $xx[id]; ?>', 
...
$dud++; }
 if($dud>0){
?>
 <tr bgcolor="#DDDDDD"  onClick="wComparew3www_6b = window.open('x_sefxsdsds.php?urr=1&NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>', 
...
$dud2++; }
 if($dud2>0){
?>
 <tr bgcolor="#DDDDDD"  onClick="wComparew3www_6b = window.open('x_sefxsdsds.php?urr=2&NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>', 
  'wComparew3www_6b', 'width=730,height=290,left=170,Top=112,resizable=yes,directories=no,status=no,toolbar=no,menubar=0,location=no,scrollbars=yes'); 
    wComparew3www_6b.focus();"  onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';">
...
$dud4++; }
 if($dud4>0){
?>
 <tr  onClick="wComparew3www_6b = window.open('x_sefxsdsds.php?urr=3&NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>', 
  'wComparew3www_6b', 'width=730,height=290,left=170,Top=112,resizable=yes,directories=no,status=no,toolbar=no,menubar=0,location=no,scrollbars=yes'); 
...
$dud5++; }
 if($dud5>0){
?>
 <tr  onClick="wComparew3www_6b = window.open('x_sefxsdsds.php?urr=4&NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>', 
  'wComparew3www_6b', 'width=730,height=290,left=170,Top=112,resizable=yes,directories=no,status=no,toolbar=no,menubar=0,location=no,scrollbars=yes'); 
    wComparew3www_6b.focus();"  onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" bgcolor="#DDDDDD">
 <td><div align="center"><? $nomer= $nomer+1; 
 echo $nomer; ?></div></td>
...
$dud6++; }
 if($dud6>0){
?>
 <tr bgcolor="#DDDDDD"  onClick="wComparew3www_6b = window.open('x_sefxsdsds.php?urr=5&NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>', 
  'wComparew3www_6b', 'width=730,height=290,left=170,Top=112,resizable=yes,directories=no,status=no,toolbar=no,menubar=0,location=no,scrollbars=yes'); 
    wComparew3www_6b.focus();"  onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" >
 <td><div align="center"><? $nomer= $nomer+1; 
 echo $nomer; ?></div></td>
