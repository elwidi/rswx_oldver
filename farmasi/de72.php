...
?>
 ...
 <tr >
  ...
  <tr  onClick="location.href='de72.php?nom=<? echo $nom+1; ?>&id=<? echo $id; ?>&awal=<? echo $awal+7; ?>';" onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" valign="top">
