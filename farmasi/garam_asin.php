...
VALUES (NULL,'$ii[NoResep]','$Tgl','$Bln','$Thn','$NoResep','$ii[id]',
'$ii[id]', 'RL','RL',
'$Kob','$g1[NamaObat]','$Qty','$regane2', 
'$JmlHargaBeli','$ii[NamaPer]','$hb[NamaSatuan]','$g1[KodeKategori]','$g1[NamaKategori]',
'$a[Nama]','$RacKe','$Mingo','$ttr','$Rc','$hjuy','$Rc','$rtr','$trt','RL','$Resep Luar','$Tiga2X','$Rev2','1','$hb[id]','$Total2')");
  
if($isikan){
  header("Location:./adik_dhimas.php?jangan=fitnah&id=$id&Rc=$Rc");
}else{
