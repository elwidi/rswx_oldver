...
<?
$juy = 1; $nom=1;
$ddt = mysql_query("SELECT * FROM jualobat_tmp WHERE JamTran='$NoResep' AND Qty>0 AND apa_r=1 ORDER BY apa_r DESC");
...
<?  $nom++; } 
$ujdujduddf =mysql_query("SELECT COUNT(id) AS jj FROM jualobat_tmp WHERE JamTran='$NoResep' AND Qty>0 AND apa_r=1");
...
<? } ?>
 <?
 $juy2=2;
$ddt2 = mysql_query("SELECT * FROM jualobat_tmp WHERE JamTran='$NoResep' AND Qty>0 AND apa_r!=1 ORDER BY apa_r DESC");
