...
<table border="0" cellpadding="2" cellspacing="2" class="style23">
  <tr>
	<td width="30" bgcolor="#FFCC99"><div align="center"><strong>NO</strong></div></td>
		<td width="328" bgcolor="#FFCC99"><strong>NAMA OBAT</strong></td>
		<td>SATUAN</td>
		<td width="51" bgcolor="#FFCC99"><div align="center"><strong>QTY</strong></div></td>
		
		<td width="94" bgcolor="#FFCC99"><div align="right"><strong>HARGA</strong></div></td>
		<td width="65" bgcolor="#FFCC99"><div align="right"><strong>TOTAL</strong></div></td>
  </tr>
		<?
	 
 		$nomer=1;
 		$sdsjksjkds  = mysql_query("SELECT * FROM jualobat_tmp WHERE JamTran='$NoResep' AND apa_r!=1 order by id  asc");
...
$warna='bgcolor="#C6FDBD"';
		...
		?>
 		<tr  <? echo $color;  echo $warna; ?> onClick="wComparew3www = window.open('hsa_3.php?NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>&IdDetil=<? echo $xx[id]; ?>', 
  'wComparew3www', 'width=630,height=290,left=470,Top=212,resizable=yes,directories=no,status=no,toolbar=no,menubar=0,location=no,scrollbars=yes'); 
    wComparew3www.focus();"  onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" >
		  ...
		  <td><div align="left"><? echo ucfirst(strtolower($xx[Satuan])); ?></div></td>
		  <td><div align="center"><?
		 $pcds = explode(".",$xx[Qty]); 
  $ccdrd = $pcds[1]-0;
  if($ccdrd>0){
  ...
  echo number_format($xx[Qty]);
		  ...
		  ?></div></td>
		  <td><div align="right"><? 
		   $bel = $xx[Pengali]*$xx[HargaBeli];
		  		  echo number_format($bel);
 ?></div></td>
  <td><div align="right"><?  
		  		  echo number_format($xx[Total2]);
				  $tot = $tot + $xx[Total2];
 ?></div></td>
  </tr><?
		   ?>
...
<?
 $dud=0;
 $kdodkddddodk = mysql_query("SELECT *  FROM jualobat_tmp WHERE JamTran='$NoResep' AND stat=1 AND apa_r=1");
...
$dud++; }
 if($dud>0){
?>
 <tr bgcolor="#DDDDDD"  onClick="wComparew3www_6b = window.open('x_sef.php?urr=1&NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>', 
 ...
 <td colspan="4" valign="top"><div align="left">
  ...
  <?
 $noc=1;
   $kdodkddddodk_jhjhj = mysql_query("SELECT *  FROM jualobat_tmp WHERE JamTran='$NoResep' AND stat=1 AND apa_r=1");
...
?>
  ...
  <td width="34"><div align="center"><? echo number_format($sa[Qty],2); ?></div></td>
  </tr>
  <? $noc++; } ?>
  </table>
  </div>
 ...
 <?
  $kdodkddddodk2 = mysql_query("SELECT *  FROM jualobat_tmp WHERE JamTran='$NoResep' AND stat=2 AND apa_r=1");
while($hh2x = mysql_fetch_array($kdodkddddodk2)){
  $totSzx = $totSzx + $hh2x[JmlHargaBeli];
$dud2++; }
 if($dud2>0){
?>
 <tr bgcolor="#DDDDDD"  onClick="wComparew3www_6b = window.open('x_sef.php?urr=2&NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>', 
  'wComparew3www_6b', 'width=730,height=290,left=170,Top=112,resizable=yes,directories=no,status=no,toolbar=no,menubar=0,location=no,scrollbars=yes'); 
    wComparew3www_6b.focus();"  onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';">
 ...
 <td colspan="4" valign="top"><div align="left">
  ...
  <?
 $nocx=1;
   $kdodkddddodk_jhjhjx = mysql_query("SELECT *  FROM jualobat_tmp WHERE JamTran='$NoResep' AND stat=2 AND apa_r=1");
...
?>
  ...
  <? $nocx++; } ?>
   ...
   $nomer=$nomer+1;
  $kdodkddddodk4 = mysql_query("SELECT *  FROM jualobat_tmp WHERE JamTran='$NoResep' AND stat=3 AND apa_r=1");
while($hh2x4 = mysql_fetch_array($kdodkddddodk4)){
  $totSzx4 = $totSzx4 + $hh2x4[JmlHargaBeli];
$dud4++; }
 if($dud4>0){
?>
 <tr  onClick="wComparew3www_6b = window.open('x_sef.php?urr=3&NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>', 
  'wComparew3www_6b', 'width=730,height=290,left=170,Top=112,resizable=yes,directories=no,status=no,toolbar=no,menubar=0,location=no,scrollbars=yes'); 
 ...
 <td colspan="4" valign="top"><div align="left">
  ...
  <?
 $nocx3=1;
   $kdodkddddodk_jhjhjx3 = mysql_query("SELECT *  FROM jualobat_tmp WHERE JamTran='$NoResep' AND stat=3 AND apa_r=1");
...
?>
  ...
  <? $nocx3++; } ?>
    ...
    <?
   $nomer=$nomer+1;
  $kdodkddddodk5 = mysql_query("SELECT *  FROM jualobat_tmp WHERE JamTran='$NoResep' AND stat=4 AND apa_r=1");
while($hh2x5 = mysql_fetch_array($kdodkddddodk5)){
  $totSzx5 = $totSzx5 + $hh2x5[JmlHargaBeli];
$dud5++; }
 if($dud5>0){
?>
 <tr  onClick="wComparew3www_6b = window.open('x_sef.php?urr=4&NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>', 
  'wComparew3www_6b', 'width=730,height=290,left=170,Top=112,resizable=yes,directories=no,status=no,toolbar=no,menubar=0,location=no,scrollbars=yes'); 
    wComparew3www_6b.focus();"  onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" bgcolor="#DDDDDD">
 <td><div align="center"><? $nomer= $nomer+1; 
 echo $nomer; ?></div></td>
 ...
 <td colspan="4" valign="top"><div align="left">
  ...
  <?
 $nocx4=1;
   $kdodkddddodk_jhjhjx4 = mysql_query("SELECT *  FROM jualobat_tmp WHERE JamTran='$NoResep' AND stat=4 AND apa_r=1");
...
?>
  ...
  <? $nocx4++; } ?>
     ...
     <?
   $nomer=$nomer+1;
  $kdodkddddodk6 = mysql_query("SELECT *  FROM jualobat_tmp WHERE JamTran='$NoResep' AND stat=5 AND apa_r=1");
while($hh2x6 = mysql_fetch_array($kdodkddddodk6)){
  $totSzx6 = $totSzx6 + $hh2x6[JmlHargaBeli];
$dud6++; }
 if($dud6>0){
?>
 <tr bgcolor="#DDDDDD"  onClick="wComparew3www_6b = window.open('x_sef.php?urr=5&NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>', 
  'wComparew3www_6b', 'width=730,height=290,left=170,Top=112,resizable=yes,directories=no,status=no,toolbar=no,menubar=0,location=no,scrollbars=yes'); 
    wComparew3www_6b.focus();"  onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" >
 <td><div align="center"><? $nomer= $nomer+1; 
 echo $nomer; ?></div></td>
 ...
 <? }
 $tot2 = $tot+$totSz2+$totSz2x+$totSz2x4+$totSz2x5+$totSz2x6;
  ?>
  <tr>
 <td colspan="4" valign="top"><div align="left">
  <div align="left">
  ...
  <?
 $nocx5=1;
   $kdodkddddodk_jhjhjx5 = mysql_query("SELECT *  FROM jualobat_tmp WHERE JamTran='$NoResep' AND stat=5 AND apa_r=1");
...
?>
  ...
  <? $nocx5++; } ?>
    ...
    <td colspan="4" bgcolor="#FFCC99"><div align="center">TOTAL</div></td>
		  <td colspan="2" bgcolor="#FFCC99"><div align="right"><? echo number_format($tot2); ?></div></td>
  </tr>
</table>
</body>
</html>