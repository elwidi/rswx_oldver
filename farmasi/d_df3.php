...
<tr class="style3">
<td width="137"><span class="style8">Rm No / Penjamin</span></td>
<td width="7"><div align="center"><span class="style14">:</span></div></td>
<td width="199"><div align="left" class="style8"><? echo $ii[NoPasien]; ?>
/ <? echo ucfirst(strtolower($ii[NamaPer])); ?></div></td>
</tr>
<tr class="style3">
<td width="137"><span class="style8">Resep No </span></td>
<td width="7"><div align="center"><span class="style14">:</span></div></td>
<td width="199"><div align="left" class="style8"><? echo $NoResep; ?></div></td>
</tr>
<tr class="style3">
<td width="137"><span class="style8">Tgl</span></td>
<td width="7"><div align="center"><span class="style14">:</span></div></td>
<td width="199"><div align="left" class="style8"><? echo "$ii[TglMasuk]";
$bln=$ii[BlnMasuk];
$thn1 = $ii[ThnMasuk];
...
<?
$juy = 1;  
$ddtWS = mysql_query("SELECT * FROM jualobat WHERE JamTran='$NoResep' AND Qty>0 AND apa_r=0  ORDER BY id asc");
while($ssWS = mysql_fetch_array($ddtWS)){
$Kary = $Kary +$ssWS[RevKary];
$Rss = $Rss + $ssWS[RevRs];
?>
...
<td   onClick="wCompare_09j = window.open('x3_0a.php?NoResep=<? echo $NoResep; ?>&id=<? echo $id;?>&Detil=<? echo $ssWS[id]; ?>', 
...
-->
   ...
   <tr>
	   <td  colspan="3" class="style3"><div align="center">Tgg  Karyawan</div></td>
	  
	   <td width="103" class="style3"><div align="right">
	     <?
		 echo number_format($Kary);
	   ?>
	     </div></td>
	   </tr>
	   <tr>
	     <td colspan="3" class="style3"> <div align="center">Tangg Rs </div></td>
	  
	     <td class="style3"><div align="right">
	       <?
		 echo number_format($Rss);
		 $tot_rr = $Rss+$Kary;
		 ?>
	       </div></td>
	     </tr>
...
<tr valign="top">
  <td colspan="3">
    <div align="right">
       <table width="360" border="0" cellpadding="1" cellspacing="1">
	   <tr valign="top">
