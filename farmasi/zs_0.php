...
if($a[Level]==77){
header("Location:../Daftar/ed_d.php?ade=3");
}elseif($a[Level]==9 || $a[Level]==91  || $a[Level]==112 || $a[Level]==11){
?>
<html>
...
<body>
<table border="0"   onClick="location.href='../Daftar/ed_d.php?ade=3';" onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';">
<tr class="style3">
...
<td><div align="center"><span class="style14">:</span></div></td>
<td><div align="left" class=" ">0</div></td>
</tr>
<tr class="style3">
...
<?
$juy = 1;
$ddt = mysql_query("SELECT * FROM jualobat WHERE JamTran='$NoResep' AND Qty>0 AND apa_r!=1");
...
<? $juy++; } 
$jkjioi = mysql_query("SELECT COUNT(id) AS jh FROM jualobat WHERE JamTran='$NoResep' AND apa_r=1");
...
?></em></div></td><td><div align="right" class="style11"><em>
  <? 
$jauiu = mysql_query("SELECT SUM(JmlHargaBeli) AS jh FROM jualobat WHERE JamTran='$NoResep' AND apa_r=1 AND Qty>0");
