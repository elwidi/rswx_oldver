...
include "../bulan.php";
 ?> </div></td>
    ...
    <tr valign="top" class="style23">
      <td colspan="3"><div align="left"> <a href="index.php"   onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';"  style="text-decoration:none">KEMBALI</a> || <a  href="#" style="text-decoration:none"  onClick="wCompare4f3w12 = window.open('../lg/c2a0.php?as=3', 
  'wCompare4f3w12', 'width=400,height=140,left=170,Top=150,resizable=yes,directories=no,status=no,toolbar=no,menubar=0,location=no,scrollbars=yes'); 
    wCompare4f3w12.focus();"  onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';">CEK PERIODE</a> 
	 || <a   onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" href="d09m.php?iin=hari&Bln=<? echo $Bln; ?>&Thn=<? echo $Thn; ?>" style="text-decoration:none">EXPOR KE EXCEL</a></div></td>
    </tr>
    <tr valign="top">
  ...
  ////////////////================================================
  ?>
            <tr onClick="wCompare4f4ds312 = window.open('../lg/n5g.php?id=<? echo $bb[IdSupplier]; ?>&Bln=<? echo $Bln; ?>&Thn=<? echo $Thn; ?>', 
  'wCompare4f4ds312', 'width=880,height=400,left=370,Top=150,resizable=yes,directories=no,status=no,toolbar=no,menubar=0,location=no,scrollbars=yes'); 
    wCompare4f4ds312.focus();"  onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';"  valign="top" <? echo $warna; ?>>
