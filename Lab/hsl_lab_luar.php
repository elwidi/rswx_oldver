...
<div align="left">
  <table width="727" border="0" cellpadding="0" cellspacing="0">
    ...
    <TR onClick="location.href='nasi_kucing.php?hari=<? echo $fito; ?>';" onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" valign="top">
      <td height="82" colspan="2">
	  <table border="0" cellpadding="2" cellspacing="2">
	  <tr valign="top">
	  <td width="97"><img src="../gb/gb.png" width="100" height="86" /></td>
	  <td width="614"><div align="left">
...
echo $ya_p[NamaDokter];	
 ...
 ><TD colspan="2">
	   ...
	   <div align="left">
	   <table 
	    onClick="location.href='suit.php?fito=<? echo $fito; ?>&ak=1&tanto=1';" onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" width="719"  border="0" cellpadding="2" cellspacing="2"> 
...
$Rea="$kp[id].$kp[RegId]";
	...
	echo ucfirst(strtolower($kp[NamaPerujuk])); 
	?></div></td>
    </tr>
        </table>
	   </div>	   </td>
        ...
        <tr>
          <td > 
           	  <table  border="0" cellspacing="1" cellpadding="1">
             	 <TR  bgcolor="#CCCCCC">
               	 <TD  ><SPAN class="style3">JENIS PEMERIKSAAN</SPAN></TD>
     			 <td width="161"><div align="center"><SPAN class="style3">HASIL</SPAN></div></td>
				 <td width="101"><div align="center"><SPAN class="style3">SATUAN</SPAN></div></td>
				 <td width="200"><div align="center"><SPAN class="style3">NILAI rujukan</SPAN></div></td>
                   <td width="128"><div align="center"><SPAN class="style3">KET</SPAN></div></td>
    </TR>
              <?
$KA=1;
if($akan==2){
...
?>
              <tr>
			  <TD colspan="5"><div align="left" class="style8"><?
if($ak==1){ 
...
<? echo $ui[NamaBiaya];    //echo "($ui[NamaBiaya])"; ?></a> </div></td>
