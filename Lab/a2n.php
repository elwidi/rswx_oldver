...
<tr>
  <td colspan="3">
    ...
    <a href="a2n.php?tgl1=<? echo $tgl1; ?>&tgl2=<? echo $tgl2; ?>&bln1=<? echo $bln1; ?>&thn1=<? echo $thn1; ?>" style="text-decoration:none">PER KELAS</a> || 
      <a href="a8.php?tgl1=<? echo $tgl1; ?>&tgl2=<? echo $tgl2; ?>&bln1=<? echo $bln1; ?>&thn1=<? echo $thn1; ?>" style="text-decoration:none">GLOBAL</a></span> </td>
</tr>
<tr>
...
<td><div align="left"><? echo $vv[NamaKelas];
   ?></div></td>
<td><div align="center"><?
   $kjfkfogfgdfdfdf= mysql_query("SELECT COUNT(id) AS jj from txninap2 where NoBukti like 'LAB-%' AND Kelas='$vv[NamaKelas]' AND Tgl<=$tgl2 AND Tgl>=$tgl1 AND Bln=$bln1 AND Thn=$thn1");
