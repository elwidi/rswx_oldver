...
<form action="sepak_bola.php"> 
  <div align="left">
    <table border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
      <tr >
        <td height="38" colspan="3" bgcolor="#FFFFFF"><div align="center" class="style1">
      ...
      <tr valign="top">
        <td colspan="3"><div align="left">
          <table border="0" cellpadding="1" cellspacing="1">
            <?
$biuk = mysql_query("SELECT * FROM labumum2 WHERE id='$iki'");
...
?>
    ...
    <td><div align="center" class="style4"><strong>:</strong></div></td><TD><span class="style4">
      <textarea name="Alamat" cols="30" rows="3" class="style4"><? echo $ap[Alamat]; ?></textarea>
            ...
            <tr bgcolor="#FFCC00">
              <td colspan="3" bgcolor="#3FA238"><div align="center">
