...
include "../ceke.php";
$id = $_GET["id"];
 $jdjdjd = mysql_query("SELECT * FROM rujukan_lab WHERE id='$id'");
$uu = mysql_fetch_array($jdjdjd);
/*
if($FiLaDim2[Rujukan]!=1){
...
var Result =''+data.id+'';;
location.href="jujur_adalah_jalan_indah.php?nas=45&id=" + Result;
			}
		);
	});
...
<td colspan="3" ><img src="../gambar/laboratorium.gif"></td>
</tr>
<tr>
...
<tr>
  ...
  if($uu[id]){
  ?>
  <input type="button" name="dfd" value="Reset" onClick="location.href='jujur_adalah_jalan_indah.php';" class="style1"  onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';">
  <?
  }
  ?>
  ...
  <table border="1">
  <tr>
  <td width="742" valign="top"><div align="left">
  ...
  <table width="734" border="0" cellpadding="2" cellspacing="2" class="style2">
 <tr>
 <td width="32"   bgcolor="#58BB4F"><div align="center"><strong>NO</strong></div></td>
 <td width="325" bgcolor="#58BB4F"><strong>NAMA RUJUKAN </strong></td>
  <td width="159" bgcolor="#58BB4F"><strong>ALAMAT</strong></td>
  <td width="85" bgcolor="#FFCC99">HP</td>
  <td width="101" bgcolor="#FFCC99">TELP</td>
 </tr>
 <?
 $nomer =1;
 $nas = $_GET["nas"];
 ...
 if($nas==45){
 $jsmsjsm = mysql_query("SELECT * FROM rujukan_lab WHERE id='$id'");
 }elseif($anak>0){
 $jsmsjsm = mysql_query("SELECT * FROM rujukan_lab WHERE NamaRujukan LIKE '$NamaDokter%' ORDER BY id desc LIMIT 0,30");
 }else{
 $jsmsjsm = mysql_query("SELECT * FROM rujukan_lab ORDER BY id desc LIMIT 0,30");
 }
...
?> 
 <tr <? echo $warna; ?>  onClick="location.href='jujur_adalah_jalan_indah.php?id=<? echo $vv[id]; ?>';" onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" valign="top"> 
 <td><div align="center"><? echo $nomer; ?></div></td>
 <td><div align="left"><? echo $vv[NamaRujukan]; ?></div></td>
  <td><div align="left"><?
  echo strtoupper($vv[Alamat]); 
  ?></div></td>
  <td><div align="left"><? echo $vv[Telp]; ?></div></td>
  <td><div align="left"><? echo $vv[Hp]; ?></div></td>
 </tr>
 <?
 $nomer++; } ?>
 </table>
