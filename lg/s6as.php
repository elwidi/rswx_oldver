...
<tr valign="top">
  ...
  <td width="188" bgcolor="#CCCCCC"><strong>NAMA BARANG </strong></td>
  <td width="52" bgcolor="#CCCCCC"><div align="center"><strong>STOK</strong></div></td><td width="84" bgcolor="#CCCCCC"><strong>SATUAN</strong></td>
   
  </tr>
  <?
   $nomer=1; $nemer=1;
  $kdjfkdjfd_dkdfd  = mysql_query("SELECT * FROM stok_opm2 WHERE IdUnit='$uy[id]'");
  ...
  ?></div></td>
   ...
   ?></div></td>
<td><div align="left"><? echo $ii[NamaBarang]; ?></div></td>
   
   <td onClick="location.href='v9s8.php?IdBarang=<? echo $ii[IdBarang]; ?>&id=<? echo $Tag; ?>';" onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';" ><div align="center"><?
   $IdBarang=$ii[IdBarang];  
   include "stok_umum.php";
   ?></div></td>
