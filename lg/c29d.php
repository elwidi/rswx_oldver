...
//
$ldjfd090df = mysql_query("SELECT * FROM oder_2detil WHERE id='$IdDetil'");
...
<font color="#990000"><?
echo $yh[NamaBarang]; echo "<br> QTY $yh[Qty] $yh[NamaSatuan]";
?>.<br>
<input type="button" name="ffg" value="YA" onclick="location.href='dd98d.php?id=<? echo $id; ?>&IdDetil=<? echo $IdDetil; ?>';" /> || 
