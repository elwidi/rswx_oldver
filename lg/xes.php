...
<tr>
  ...
  'wCompare4f4d12', 'width=580,height=500,left=270,Top=150,resizable=yes,directories=no,status=no,toolbar=no,menubar=0,location=no,scrollbars=yes'); 
	...
	<input type="button" name="fgfg" value="Kirim"  onClick="wCompare4f23232324d12 = window.open('cw.php?id=<? echo $id; ?>', 
...
<tr valign="top">
  <td colspan="3"><div align="left">
   <iframe src="n6.php?id=<? echo $id; ?>" width="800" height="250" frameborder="0"></iframe>
  </div></td>
</tr>
</table>
</form>
