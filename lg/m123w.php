...
<!-- 
function win44(){
window.opener.location.href="roberta_sri_susanti.php?kakang=<? echo $kakang; ?>&IdBarang=<? echo $IdBarang; ?>&id=<? echo $id; ?>&ukur=<? echo $ukur; ?>";
self.close();
//-->
} 
...
//
$i8diu = mysql_query("SELECT id FROM  stok_opm2 WHERE KeyID='$a[KodeBagian]-$hs[id]'");
...
?>
<tr onClick="location.href='m123w.php?kakang=<? echo $kakang; ?>&IdBarang=<? echo $hs[id]; ?>&id=<? echo $id; ?>&ukur=<? echo $ukur; ?>';" valign="top" <? echo $warna; ?> onMouseOver="movein(this,'');window.status='';" onMouseOut="moveout(this);window.status='';">
