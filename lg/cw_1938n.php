...
-->
  ...
  <span class="style1">YAKIN DATA INI AKAN DIKIRIM SEBAGAI PERMINTAAN KE LOGISTIK UMUM </span><br />
 <font color="#FFFFFF"><b><?
 echo "MT-$id<br>";
 ?></b>
 <input type="button" name="ggfgf" value="YA" onClick="location.href='fito_sayang_dimas.php?id=<? echo $id; ?>';" />
  || 
